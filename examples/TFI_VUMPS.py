...
if __name__ == "__main__":
    ...
    parser.add_argument('--epsilon', help='desired convergence of the gradient (1E-8)',type=float,default=1E-8)
    ...
    parser.add_argument('--artol', help='tolerance of the arnoldi sovler (1E-10)',type=float,default=1E-10)    
